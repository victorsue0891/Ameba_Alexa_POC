...
char ssid[] = "victor_sue_iPhone";     // your network SSID (name)
char pass[] = "12345678";  // your network password (use for WPA, or use as key for WEP)
int keyIndex = 0;                // your network key Index number (needed only for WEP)

char avs_lwa_redirect_host[] = "amazon.com";
char avs_lwa_api_host[]      = "api.amazon.com";
char avs_client_id[]         = "amzn1.application-oa2-client.e096a4b67b47478fbf2b6b2fad74d8a4";
char avs_client_secret[]     = "a6f6c4de34d69c18979e96ee2115f19baccc424bb2ed5f7597646270ad1aba17";
